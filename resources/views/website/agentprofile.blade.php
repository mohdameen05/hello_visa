                                        ...
                                        <div class="ct_inner_form">
                                            ...
                                            <div class="ct_profile_img">
                                                ...
                                                <div class="ct_prifle_info">
                                                    <h4 class="text-dark">{{ (Session::get('agent_info'))?ucfirst(Session::get('agent_info')['name']):'User'}}</h4>
                                                </div>
                                            </div>
                                            <form action="{{route('agent.update',Session::get('agent_info')['id']);}}" method="post">
                                              @csrf
                                              @method('PUT')
                                                <div class="ct_label_float mb-3">
                                                    <input type="text" name="name" value=" {{ Session::get('agent_info')['name'] }}" placeholder="Please Enter Name "/>
                                                    <label>Name</label>
                                                  </div>
                                                
                                                  <div class="ct_label_float mb-3">
                                                    <input type="email" name="email" value=" {{ Session::get('agent_info')['email'] }}" placeholder="Please Enter Email "/>
                                                    <label>Email</label>
                                                  </div> 

                                                  <div class="ct_label_float mb-3">
                                                    <input type="text" name="username" value=" {{ Session::get('agent_info')['username'] }}" placeholder="Please Enter Username "/>
                                                    <label>Email</label>
                                                  </div>
                                                  <div class="ct_label_float mb-3">
