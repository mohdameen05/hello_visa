                            ...
                            <div class="main-menu-three__bottom-inner">
                                <div class="main-menu-three__main-menu-box">
                                    ...
                                    <ul class="main-menu__list one-page-scroll-menu">
                                        ...
                                        <li>
                                            <div class="main-menu-three__btn dropdown ct_profile_dropdown ct_account_btn">
                                                <a href="#" id="dropdownMenuButton12" data-bs-toggle="dropdown" class="dropdown-toggle" aria-expanded="false">My Account ({{ (Session::get('agent_info'))?ucfirst(Session::get('agent_info')['name']):'User'}})</a>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton12">
                                                   <li><a class="dropdown-item" href="{{route('agent.edit',41);}}">Profile</a></li>
                                                   <li><a class="dropdown-item" href="{{url('agent_logout')}}">Logout</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                    </ul>
