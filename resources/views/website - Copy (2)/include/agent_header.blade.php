                                    ...
                                    <ul class="main-menu__list one-page-scroll-menu">
                                        ...
                                        <li>
                                            <div class="main-menu-three__btn dropdown ct_profile_dropdown ct_account_btn">
                                                <a href="#" id="dropdownMenuButton12" data-bs-toggle="dropdown" class="dropdown-toggle" aria-expanded="false">My Account (John)</a>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton12">
                                                   ...
                                                   <li><a class="dropdown-item" href="profile.html">Logout</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                    </ul>
