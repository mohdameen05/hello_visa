              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">  
                     <a type="button" class="btn btn-primary btn-rounded btn-fw" data-toggle="modal" data-target="#myModal" > Add Category </a> 
                  </li>
                </ol>
              </nav>
            </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-outline-primary" data-toggle="modal" data-target="#myModal{{$content->id}}" > Edit </button>
                             ...
                             <button class="btn btn-outline-danger callDelete" current-id="{{$content->id}}" tableId="1" > Delete </button> 
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <form action="{{url('category-update')}}" method="post" class="form-sample" enctype="multipart/form-data" >
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <form action="{{url('category-save')}}" method="post" class="form-sample" enctype="multipart/form-data" >
